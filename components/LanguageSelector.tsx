  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="w-full px-3 py-2 text-left bg-white border border-gray-300 rounded-lg hover:border-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer flex items-center justify-between"
      >
        ...
        <div className="absolute z-50 w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl overflow-hidden">
          {languages.map(([key, lang]) => (
            ...
            >
              ...
              ></span>
              <span className={`text-sm font-medium ${key === value ? 'text-indigo-700' : 'text-gray-700'}`}>
                {lang.name}
              </span>
              {key === value && (
